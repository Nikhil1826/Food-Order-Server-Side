...
import com.fasttech.foodorderserver2.Model.Food;
import com.fasttech.foodorderserver2.ViewHolder.FoodViewHolder;
...
public class FoodListActivity extends AppCompatActivity {
    ...
    private void showAddFoodDialog() {
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(saveUri==null || edtName.getText().toString().isEmpty() || edtDescription.getText().toString().isEmpty() || edtPrice.getText().toString().isEmpty() || edtDiscount.getText().toString().isEmpty()){
                    Toast.makeText(FoodListActivity.this,"Please fill the entire details!!\nOR\nMake sure an Image is selected!!",Toast.LENGTH_LONG).show();
                }else
                uploadImage();
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(newFood!=null){
                    ...
                    Snackbar.make(findViewById(R.id.rootLayout),"New food item "+"\""+newFood.getName()+"\""+" added",Snackbar.LENGTH_LONG).show();
    ...
    private void uploadImage() {
        final SpotsDialog dialog = new SpotsDialog(FoodListActivity.this, R.style.Custom);
    ...
    private void loadFoodList(String categoryId) {
        adapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(Food.class, R.layout.food_item, FoodViewHolder.class, foodList.orderByChild("menuId").equalTo(categoryId)//similar to  Select * from Foods where MenuId=menuId
        ) {
            @Override
    ...
    private void deleteFood(String key, Food item) {
        ...
        Snackbar.make(findViewById(R.id.rootLayout),"Food item "+"\""+item.getName()+"\""+" deleted",Snackbar.LENGTH_SHORT).show();
    }
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
                    ...
                    Snackbar.make(findViewById(R.id.rootLayout),"Food item "+"\""+item.getName()+"\""+" updated",Snackbar.LENGTH_LONG).show();
